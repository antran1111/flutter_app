...
//this app will contain all the locations that we need.
class Location {
  final int id;
  String name;
  String imagePath;
  ...
  static Location fetchByID(int locationID) {
    //fetch all locations, iterate them and when we find the location with the id want return it
  ...
  static List<Location> fetchAll() {
    return [
      Location(1, 'Kiyomizu-dera', 'assets/images/japan1.png', [
        // ...
      ...
      Location(2, 'Mount Fuji', 'assets/images/japan2.png', [
        // ...
        LocationFact('Summary',
      ...
      Location(3, 'Arashiyama Bamboo Grove', 'assets/images/japan3.png', [
        // ...
        LocationFact('Summary',
